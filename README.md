...
- Semantics of html. Added main section
- Refactored css and remove unnecessary duplications
...
```
#### Unresolved issues
- Ensure text remains visible during webfont load (error in lighthouse)
- Serve static assets with an efficient cache policy (error in lighthouse)
- Eliminate render-blocking resources (/css2?family=Allison(fonts.googleapis.com)) when checking lighthouse for mobile.
---
### Validation 
...
![The image shows the accessibility report](assets/images/lighthouse-desktop.png)
##### Mobile Lighthouse report
![The image shows the accessibility report](assets/images/lighthouse-mobile.png)
 ...
 <figure>
  ...
  <figcaption>Figure 6. The summary report generated by Wave validation tool</figcaption>
</figure>
